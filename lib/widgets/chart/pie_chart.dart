...
import 'package:expense_tracker_v1/widgets/expenses.dart';

class PieChartSample3 extends StatefulWidget {
  final List<Expense> expenses;

  const PieChartSample3({super.key, required this.expenses});
...
class PieChartSample3State extends State {
  ...
  //   (widget as Expenses).expenses.forEach((expense) {
